...
const {MAIN_ADMIN, EMPLOYEE, EMPLOYEE_MANAGER, EMPLOYEE_OPERATOR, COMPANY_ADMIN} = require('../constants/roles');
...
router.get('', auth.AUTH([EMPLOYEE, MAIN_ADMIN, COMPANY_ADMIN], [EMPLOYEE_MANAGER, EMPLOYEE_OPERATOR]), getServices);
